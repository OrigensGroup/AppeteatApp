    ...
    return (
        ...
        >
            <FilterModalContainer>
                <FilterPopUpContainer>
                    <TitleWrapper>
                        <Title color="black" fontSize={18} fontWeight="bold">{filterTransaltions.titleField.placeholder}</Title>
                    </TitleWrapper>
                    <FilterModalTbasContainer>
                        <FilterModalTabs filterTabs={Object.keys(FILTERS_DATA)} onChange={onSwipe} tabActive={filterIndex}></FilterModalTabs>
                    </FilterModalTbasContainer>
                    <DivLine />
                    ...
                    <AllergyInfoWrapper>
                        <Title color='#F69019' fontSize={18}>{filterTransaltions.allergyField.placeholder}</Title>
                    </AllergyInfoWrapper>
                    <FilterModalBottomBar>
                        <DivLine />
                        <FilterModalBottomBarWrapper>
                            <BottomButtonContainer>
                                <BottomButtonWrapperLeft>
                                    <Title color="white" fontSize={18} fontWeight="bold">{filterTransaltions.clearAllField.placeholder}</Title>
                                </BottomButtonWrapperLeft>
                            </BottomButtonContainer>
                            <BottomButtonContainer>
                                <BottomButtonWrapperRight>
                                    <Title color="white" fontSize={18} fontWeight="bold">{filterTransaltions.doneField.placeholder}</Title>
                                </BottomButtonWrapperRight>
                            </BottomButtonContainer>
                        </FilterModalBottomBarWrapper>
                    </FilterModalBottomBar>
